...
address_model = rest_api.model("Address", {
...
user_input_model = rest_api.model("UserInput", dict(
    {'password': fields.String(required=True, default='S3curePa55w0rd'), **__user_base_structure}))
...
login_input_model = rest_api.model("LoginInput", {
    'username': fields.String(required=True, default='jDoe'),
...
auth_model = rest_api.model("Auth", {
...
login_model = rest_api.model("Login", {
...
error_message_model = rest_api.model("ErrorMessage", {
